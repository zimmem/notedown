...
public class EvernoteNoteContrller {
    ...
    public List<MNote> listAll() throws EDAMUserException, EDAMSystemException, TException,
        ...
        List<MNote> mnotes = Lists.transform(notes.getNotes(), new Function<Note, MNote>() {
    ...
    public MNote createNote(@RequestBody MNote mNote) throws EDAMUserException,
        ...
        return MNote.fromNote(noteStore.getNote(created.getGuid(), true, false, false, false));
    }

    @RequestMapping(value = "/{guid}", method = RequestMethod.GET)
    public MNote getNote(@PathVariable String guid) throws EDAMUserException, EDAMSystemException,
    ...
    public MNote updateNote(@RequestBody MNote mnote) throws EDAMUserException, EDAMSystemException, TException,
                                        EDAMNotFoundException {
        NoteStoreClient noteStore = clientFactory.createNoteStoreClient();
        Note updatedNote = noteStore.updateNote(mnote.toNote());
        Note note = noteStore.getNote(updatedNote.getGuid(), true, false, false, false);
        return MNote.fromNote(note);
    }
